...
db_config 	  数据库配置文件
view		  raw_inport(usernme,passwd,mail)  和 print(usernme,passwd,mail) 
'''
...
class Sql_Statement(object):
	...
	def insert_new_account(self,user_name,user_password,user_mail):
		account = Table_account(user_name=user_name,user_password=user_password,user_mail=user_mail)
